...
import Vitory from "../../assets/victory.svg";
  ...
  const handleSignup = async () => {
    if (validateSignup()) {
      const response = await apiClient.post(
        ...
        { email, password },
        { withCredentials: true }
      );//When withCredentials: true is set in Axios, it ensures that the browser sends cookies (like session tokens or authentication tokens) along with requests to the backend.
        ...
        <div className="flex flex-col gap-10 items-center justify-center">
          <div className="flex items-center justify-center flex-col">
            <div className="flex items-center justify-center">
              ...
              <img src={Vitory} alt="Vitory Emoji" className="h-[100px]" />
            </div>
